...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_ChangeTracking = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_ChangeTracking<TShape>;
...
type __TsonicExtSurface_Microsoft_EntityFrameworkCore_ChangeTracking_Internal<TShape> =
  (
    __TsonicPreferExt<(TShape extends Microsoft_EntityFrameworkCore_ChangeTracking.ValueComparer ? __Ext_Microsoft_EntityFrameworkCore_ChangeTracking_Internal_ValueComparer : {}), (TShape extends Microsoft_EntityFrameworkCore_ChangeTracking_Internal.IStateManager ? __Ext_Microsoft_EntityFrameworkCore_ChangeTracking_Internal_IStateManager : {})>
  );

type __TsonicExtApplier_Microsoft_EntityFrameworkCore_ChangeTracking_Internal = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_ChangeTracking_Internal<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Diagnostics = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Diagnostics<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Infrastructure_Internal = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Infrastructure_Internal<TShape>;
...
type __TsonicExtSurface_Microsoft_EntityFrameworkCore_Metadata<TShape> =
  (
    __TsonicPreferExt<(TShape extends Microsoft_EntityFrameworkCore_Metadata.ConfigurationSource ? __Ext_Microsoft_EntityFrameworkCore_Metadata_ConfigurationSource : {}), (TShape extends System.Nullable_1<infer T0> ? __Ext_Microsoft_EntityFrameworkCore_Metadata_Nullable_1<T0> : {})>
  );

type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Metadata = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Metadata<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Metadata_Conventions_Internal = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Metadata_Conventions_Internal<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Migrations = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Migrations<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Migrations_Internal = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Migrations_Internal<TShape>;
...
type __TsonicExtSurface_Microsoft_EntityFrameworkCore_Storage_Internal<TShape> =
  (
    __TsonicPreferExt<(TShape extends System_Data_Common.DbParameter ? __Ext_Microsoft_EntityFrameworkCore_Storage_Internal_DbParameter : {}), (TShape extends System_Data_Common.DbParameterCollection ? __Ext_Microsoft_EntityFrameworkCore_Storage_Internal_DbParameterCollection : {})>
  );

type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Storage_Internal = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Storage_Internal<TShape>;
...
type __TsonicExtApplier_Microsoft_EntityFrameworkCore_Update = <TShape>(shape: TShape) => __TsonicExtSurface_Microsoft_EntityFrameworkCore_Update<TShape>;
...
type __TsonicExtApplier_System_Transactions = <TShape>(shape: TShape) => __TsonicExtSurface_System_Transactions<TShape>;
